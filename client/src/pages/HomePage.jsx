    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold pb-5">Featured Products</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-5">
            ...
            {[1, 2, 3, 4, 5, 6].map((product) => (
              <div key={product} className="bg-gray-100 border-[#ecd398] border-4 p-6 rounded-lg shadow-md">
                ...
                <button className="mt-4 bg-[#011638] text-white px-4 py-2 rounded-md hover:bg-[#ecd398] hover:text-black focus:outline-none focus:ring focus:border-[#011638]">Add to Cart</button>
              </div>
            ))}
          </div>
        </div>
